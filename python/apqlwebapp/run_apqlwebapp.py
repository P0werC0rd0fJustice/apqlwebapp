...
'''
This script is used to launch apqlwebapp.
...
# --------------------------
parser = argparse.ArgumentParser(description='Script to start the ApogeeQL webapp server.')
...
# Create app instance
# -------------------
from apqlwebapp import create_app
